...
namespace CommonComponents.Api.Features
{
    public class GetPortalsPage
    {
        ...
        public class Response: ResponseBase
        {
            ...
            public List<PortalDto> Entities { get; set; }
        }
        ...
        public class Handler: IRequestHandler<Request, Response>
        {
            ...
            {
                var query = from portal in _context.Portals
                    select portal;
                
                var length = await _context.Portals.CountAsync();
                
                var portals = await query.Page(request.Index, request.PageSize)
