using CommonComponents.Api.Helpers;
...
namespace CommonComponents.Api.Features
{
    public class UploadDigitalAsset
    {
        ...
        {
            public ICommonComponentsDbContext _context { get; set; }
            public IHttpContextAccessor _httpContextAccessor { get; set; }
            public Handler(ICommonComponentsDbContext context, IHttpContextAccessor httpContextAccessor)
            {
                _context = context;
